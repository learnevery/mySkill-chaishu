...
```bash
# 检查单个章节
python scripts/check_chapter_wordcount.py ./小说/项目文件夹/第01章.md

# 检查所有章节
python scripts/check_chapter_wordcount.py --all ./小说/项目文件夹/

# 自定义最小字数
python scripts/check_chapter_wordcount.py ./小说/项目文件夹/第01章.md 3500
```
